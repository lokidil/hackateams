...
11. Run the following command to set up the remote repository: `git remote add azure https://<username>@csr.scm.azurewebsites.net:443/csr.git`. You need to replace <username> with the username of the App Credentials you retrieved in _Deployment Credentials_. You can also copy the URL from *Options* in the Azure Web App.
...
13. Wait until the deployment is completed and navigate to https://csr.azurewebsites.net/privacy.html to test that the web application is running
14. Done
