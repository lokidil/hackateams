...
export interface ICsrDemoConnectorConfigState extends ITeamsBaseComponentState {
...
export interface ICsrDemoConnectorConfigProps extends ITeamsBaseComponentProps {
}
...
/**
 * Implementation of the csrDemoConnector Connector connect page
 */
export class CsrDemoConnectorConfig extends TeamsBaseComponent<ICsrDemoConnectorConfigProps, ICsrDemoConnectorConfigState> {
        ...
        if (this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/csrDemoConnector/config.html`,
