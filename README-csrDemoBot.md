...
3. Give the bot a handle (ex: `csrDemoBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://csr.azurewebsites.net/api/messages`
